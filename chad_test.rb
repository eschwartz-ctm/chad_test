...
.
So the error is there on line 4 of this file (chad_test.rb).  What's on line 4?

    require_relative 'chad'

We are trying to require the file, and it isn't there.
.
You can fix the problem by creating an empty file named chad.rb inside
of the ruby/chad directory.

Then run this test again (ruby chad_test.rb).  Make all the tests pass,
and submit your solution (exercism submit chad.rb).
